...
async function contractRoutes(server) {
    ...
    }, contract_controller_1.createContractHandler);
    ...
    }, contract_controller_1.getContractsHandler);
    ...
    }, contract_controller_1.getContractByIdHandler);
    // GET /api/contracts/by-business-operation/:businessOperationId - Get contracts for business operation
    server.get('/by-business-operation/:businessOperationId', {
        schema: {
            params: {
                type: 'object',
                properties: {
    ...
    }, contract_controller_1.getContractsByBusinessOperationHandler);
    ...
    }, contract_controller_1.updateContractHandler);
    ...
    }, contract_controller_1.deleteContractHandler);
}
