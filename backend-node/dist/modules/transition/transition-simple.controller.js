...
async function createTransitionHandler(request, reply) {
    try {
        const transition = await (0, transition_simple_service_1.createTransition)(request.body);
...
async function getTransitionsHandler(request, reply) {
    try {
        const transitions = await (0, transition_simple_service_1.getTransitions)(request.query);
...
async function getTransitionByIdHandler(request, reply) {
    try {
        ...
        const transition = await (0, transition_simple_service_1.getTransitionById)(id);
...
async function updateTransitionHandler(request, reply) {
    try {
        const { id } = request.params;
        const transition = await (0, transition_simple_service_1.updateTransition)(id, request.body);
        return reply.code(200).send(transition);
    }
    catch (error) {
...
async function updateTransitionStatusHandler(request, reply) {
    try {
        const { id } = request.params;
        const transition = await (0, transition_simple_service_1.updateTransitionStatus)(id, request.body);
        return reply.code(200).send(transition);
    }
    catch (error) {
...
async function deleteTransitionHandler(request, reply) {
    try {
        const { id } = request.params;
        const result = await (0, transition_simple_service_1.deleteTransition)(id);
