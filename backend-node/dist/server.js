...
function buildServer() {
    ...
    // SECURITY FIX: Add rate limiting protection
    ...
    // SECURITY FIX: Stricter rate limiting for authentication endpoints
    server.register(async function (server) {
        await server.register(rate_limit_1.default, {
            max: 5, // Only 5 authentication attempts per timeWindow
